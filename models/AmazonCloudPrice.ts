...
import { AmazonCloudSkuFlat } from "../typesScrapper.ts";
...
AmazonCloudPriceSchema.index({ searchCode: 1 }, {
  unique: false,
  sparse: true,
});

export type AmazonCloudPriceModelType =
  & mongoose.Document
  & Omit<AmazonCloudSkuFlat, "id">;
export default mongoose.model<AmazonCloudPriceModelType>(
  "AmazonCloudPrice",
  AmazonCloudPriceSchema,
);
