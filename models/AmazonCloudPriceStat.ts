...
import { AmazonCloudSkuStat } from "../typesScrapper.ts";
...
AmazonCloudPriceStatSchema.index({ dateCode: 1, rateCode: 1 }, {
  unique: true,
});

export type AmazonCloudPriceStatModelType =
  & mongoose.Document
  & Omit<AmazonCloudSkuStat, "id">;
export default mongoose.model<AmazonCloudPriceStatModelType>(
  "AmazonCloudPriceStat",
  AmazonCloudPriceStatSchema,
);
