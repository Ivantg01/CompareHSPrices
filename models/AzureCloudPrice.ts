...
import { AzureCloudSkuFlat } from "../typesScrapper.ts";
...
export type AzureCloudPriceModelType =
  & mongoose.Document
  & Omit<AzureCloudSkuFlat, "id">;
export default mongoose.model<AzureCloudPriceModelType>(
  "AzureCloudPrice",
  AzureCloudPriceSchema,
);
