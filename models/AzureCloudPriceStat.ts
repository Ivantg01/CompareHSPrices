...
import { AzureCloudSkuStat } from "../typesScrapper.ts";
...
export type AzureCloudPriceStatModelType =
  & mongoose.Document
  & Omit<AzureCloudSkuStat, "id">;
export default mongoose.model<AzureCloudPriceStatModelType>(
  "AzureCloudPriceStat",
  AzureCloudPriceStatSchema,
);
