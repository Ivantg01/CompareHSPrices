...
import { GoogleCloudSkuStat } from "../typesScrapper.ts";
...
export type GoogleCloudPriceStatModelType =
  & mongoose.Document
  & Omit<GoogleCloudSkuStat, "id">;
export default mongoose.model<GoogleCloudPriceStatModelType>(
  "GoogleCloudPriceStat",
  GoogleCloudPriceStatSchema,
);
